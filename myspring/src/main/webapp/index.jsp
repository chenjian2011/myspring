	...
	<div class="container-fluid">
		<div class="row">
			...
			<ul id="mobilemenu" class="accordion">
			   ...
			   <li>
					<div class="link font-per"><a href="index.html.html">Home</a></div>
			...
			<div class="col-12 col-md-12 col-lg-8">
				<div class="contact-area-two">
					...
					<div class="mail-us con-top-sin">
						...
						<p>Mail us at</p>
						<p class="con-text">Info@themejupiter.com</p>
					</div>
...
<section class="feature-area-two">
  <div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="area-heading font-per style-two">wellcome to kids care for your child</h1>
		...
		<div class="row">
			<div class="col-md-12 col-lg-5 offset-xl-1 col-xl-3">
				<div class="feature-intro wow fadeInLeft " data-wow-delay=".5s">
					<h3>OUR DAILY CARE</h3>
			...
			<div class="col-md-4 col-lg-2 col-md-2">
				<div class="sin-feature-two wow fadeInUp" data-wow-delay=".6s">
				  <div class="feat-two-img">
					...
					<p>We are group of teachers who really love childrens and enjoy every mo</p>
				</div>
			</div>
			<div class="col-md-4 col-lg-2 col-md-2">
	   ...
	   <div class="row">
		   <div class="col-md-8 col-xl-6">
			  <div class="wellcome-content wow fadeInUp" data-wow-delay=".5s">
				  ...
				  <p >Lorem ipsum dolor sit amet, consecteturExcepteur sint occaecat cupidatat non proident, sunt in cuculpa qui officiacuculpa qui officiacuculpa qui officiaLorem ipsum dolor sit amet,cuculpa qui officiacuculpa qui officiacuculpa qui officiaLorem ipsum dolor sit amet</p>
   ...
   <div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="heading-para font-w">We promised you that, we always try to take care of your childdren. 
		...
		<div class="col-lg-6 offset-xl-2 col-xl-4">
			...
			<div class="sin-up-event">
				...
				<div class="sin-up-right">
					<h5 class="font-orange">Upcoming Event Title</h5>
			...
			<div class="sin-up-event">
				...
				<div class="sin-up-right">
					<h5 class="font-sky">Upcoming Event Title</h5>
					<span><i class="fa fa-clock-o"></i>At 6.30 pm</span>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas eveniet, nemo dicta. Ullam nam</p>
				</div>
			</div>
			<div class="sin-up-event">
				...
				<div class="sin-up-right">
					<h5 class="font-per">Upcoming Event Title</h5>
					<span><i class="fa fa-clock-o"></i>At 6.30 pm</span>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas eveniet, nemo dicta. Ullam nam</p>
				</div>
			</div>
				...
				<div id="accordion" role="tablist">
					<div class="card">
						<div class="card-header" role="tab" id="headingOne">
							<h5 class="mb-0">
								<a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Upcoming Event Titles</a>
							</h5>
						</div>
	...
	<div class="row">
		...
		<div class="col-md-12 col-lg-6 col-xl-4">
		   <div class="tab-carousel owl-carousel owl-theme">
			   ...
			   <div class="sin-tab-carousel item">
				   <img src="img/bg/tab-carousel-bg-2.jpg" alt="">
			   </div>
			   <div class="sin-tab-carousel item">
				...
				<div class="parent-say-content owl-carousel owl-theme">
				   <!--single parent say-->
					...
					<div class="sin-parent-say item">
						...
						<div class="sin-parent-img">
							<img src="img/latest-news/coments-2.png" alt="">
						</div>
					</div>
					<!--single parent say-->
	 ...
	 <div class="row">
		<div class="col-sm-6 col-lg-3 ">
			<div class="single-widget">
				...
				<p class="footer-about-text">KidsCare comes with powerful theme options, which empowers you to quickly and easily build incredible store.You can handle it easily and quickly. Lots of option availavle with this. </p>
		...
		<div class="col-sm-6 col-lg-3">
		   <div class="single-widget">
				...
				<div class="sin-twitter">
					<p><a class="twitter-icon" href="">about upcoming exam</a> If you're selling audio, YouTube could be exactly what you need to market your work. <a href="">enva.to/Jv9Sj</a>  </p>
				</div>
				<div class="sin-twitter">
				   <p><a class="twitter-icon" href="">learn about our school</a> If you're selling audio, YouTube could be exactly what you need to market your work. <a href="">enva.to/Jv9Sj</a>  </p>
				</div>
				<div class="sin-twitter">
				   <p><a class="twitter-icon" href="">about two days ago</a> If you're selling audio, YouTube could be exactly what you need to market your work. <a href="">enva.to/Jv9Sj</a>  </p>
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-lg-3">
